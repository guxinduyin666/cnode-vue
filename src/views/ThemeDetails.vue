    ...
    <div class="container-panel cancel-margin-right">
      <div class="panel-top-content">
        <div class="topic-title">
          <span class="title">
            <span v-show="themeDetails.status">{{ themeDetails.status }}</span>
            {{ themeDetails.title }}
          </span>
      ...
      <div class="home-inner">
        ...
        <div class="home-inner-content cancel-padding">
          <div class="reply-content" v-for="(reply, index) in themeDetails.replies" :key="index">
            <div class="reply-header">
              <img
                class="rely-img"
                :src="reply.author.avatar_url"
                @click="jumpToUser(reply.author.loginname)"
              />
              <span
                class="author-name"
                @click="jumpToUser(reply.author.loginname)"
